...
import com.rhseung.glance.legacy_tooltip.base.ItemStackTooltipComponent
...
class DetailedTooltipTemplate(
    ...
    val modelComponent =
        ItemStackTooltipComponent(stack, Color(stack.formattedName.style.color?.rgb ?: Color.WHITE.rgb()));
    ...
    override val height: Int = components.sumOf { it.getHeight(renderer) } + (getExactSize(
        ...
        renderer
            ...
            if (components.isNotEmpty()) - pad + separatorComponentHeight + pad +
